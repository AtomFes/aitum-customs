...
Join the [Aitum Discord](https://aitum.tv/discord) and head over to `#custom-code-releases` and find the thread labeled with the action in question and @ AtomFes for assistance.
...
Log your Twitch or YouTube stream chat to a channel in your Discord. In order for this to work, you must have the following trigger(s):

- Device > Twitch/YouTube
...
Log your Twitch or YouTube stream events to a channel in your Discord. In order for this to work, you must have at least one event from Twitch or YouTube.
